            ...
            <div class="row">
                ...
                <div class="col-sm-5 form-box">
                    ...
                    <div class="form-bottom">
                        <form role="form" action="/regist.do" method="post" class="registration-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pwd" placeholder="Password..." class="form-first-name form-control" id="form-password">
                            </div>
