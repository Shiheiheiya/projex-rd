...
<head>
    ...
    <link rel="stylesheet" href="mainPage-assets/materialize/css/materialize.min.css" media="screen,projection" />
    <!-- Bootstrap Styles-->
    <link href="mainPage-assets/css/bootstrap.css" rel="stylesheet" />
    <!-- FontAwesome Styles-->
    <link href="mainPage-assets/css/font-awesome.css" rel="stylesheet" />
    <!-- Morris Chart Styles-->
    <link href="mainPage-assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- Custom Styles-->
    <link href="mainPage-assets/css/custom-styles.css" rel="stylesheet" />
    <!-- Google Fonts-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="mainPage-assets/js/Lightweight-Chart/cssCharts.css">
</head>
...
<!-- JS Scripts-->
<!-- jQuery Js -->
<script src="mainPage-assets/js/jquery-1.10.2.js"></script>

<!-- Bootstrap Js -->
<script src="mainPage-assets/js/bootstrap.min.js"></script>

<script src="mainPage-assets/materialize/js/materialize.min.js"></script>

<!-- Metis Menu Js -->
<script src="mainPage-assets/js/jquery.metisMenu.js"></script>
<!-- Morris Chart Js -->
<script src="mainPage-assets/js/morris/raphael-2.1.0.min.js"></script>
<script src="mainPage-assets/js/morris/morris.js"></script>


<script src="mainPage-assets/js/easypiechart.js"></script>
<script src="mainPage-assets/js/easypiechart-data.js"></script>

<script src="mainPage-assets/js/Lightweight-Chart/jquery.chart.js"></script>

<!-- Custom Js -->
<script src="mainPage-assets/js/custom-scripts.js"></script>
